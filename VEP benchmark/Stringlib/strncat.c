...
static inline char * strncat (char *p1, const char *p2, unsigned int n) 
/*@ With n0 m0 l0 n1 m1 l1 
    Require n == n1 && 0 <= n0 && l0[n0] == 0 && n0 < m0 && 0 <= n1 && l1[n1] == 0 && n1 < m1 && n0 + n1 < m0 && store_char_array(p1, m0, l0) * store_char_array(p2, m1, l1)
